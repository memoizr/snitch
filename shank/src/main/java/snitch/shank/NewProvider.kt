...
inline fun <A, B, C, D, T> ShankModule.new(crossinline factory: (A, B, C, D) -> T) = object :
    NewProvider4<A, B, C, D, T> {
...
inline fun <A, B, C, D, E, T> ShankModule.new(crossinline factory: (A, B, C, D, E) -> T) = object :
    NewProvider5<A, B, C, D, E, T> {
